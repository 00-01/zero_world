...
class Conversation {
  ...
  factory Conversation.fromJson(Map<String, dynamic> json) {
    return Conversation(
      ...
      type: json['type'] != null
          ? ConversationType.values.byName(json['type'] as String)
      ...
      members: json['members'] != null
          ? (json['members'] as Map<String, dynamic>).map(
              (key, value) => MapEntry(
                key,
                ConversationMember.fromJson(value as Map<String, dynamic>),
              ),
            )
          : const {},
  ...
  String getTypingDisplay() {
    final typingUsers = members.entries
        .where((entry) => entry.value.isTyping)
