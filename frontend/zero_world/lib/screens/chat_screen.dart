...
class _ChatScreenState extends State<ChatScreen> {
  ...
  void _sendTypingIndicator(bool isTyping) {
    // TODO: Send typing indicator via WebSocket or API
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            CircleAvatar(
              radius: 40,
              backgroundImage: widget.conversation.getDisplayPhoto(_currentUserId) != null
                  ? NetworkImage(widget.conversation.getDisplayPhoto(_currentUserId)!)
                  : null,
            ),
            const SizedBox(height: 16),
            Text(
