      ...
      ServiceCategory(
        ...
        services: [
          ...
          Service(
            id: 'meal_plans',
            name: 'Meal Plans',
            description: 'Weekly meal subscriptions',
      ...
      ServiceCategory(
        ...
        services: [
          ...
          Service(
            id: 'emergency',
            name: 'Emergency',
            description: 'Ambulance & urgent care',
      ...
      ServiceCategory(
        ...
        services: [
          ...
          Service(
            id: 'insurance',
            name: 'Insurance',
            description: 'Health, vehicle, home',
            icon: Icons.shield,
            color: Colors.blue,
            route: '/insurance',
          ),
          Service(
            id: 'investments',
            name: 'Investments',
            description: 'Stocks, crypto, funds',
      ...
      ServiceCategory(
        ...
        services: [
          ...
          Service(
            id: 'roommates',
            name: 'Find Roommate',
            description: 'Share accommodation',
      ...
      ServiceCategory(
        ...
        services: [
          Service(
            id: 'documents',
            name: 'ID Documents',
            description: 'Passports, licenses',
            icon: Icons.badge,
            color: Colors.blueGrey,
            route: '/documents',
          ),
          ...
          Service(
            id: 'legal',
            name: 'Legal Services',
            description: 'Lawyers & consultations',
            icon: Icons.gavel,
            color: Colors.brown,
            route: '/legal',
          ),
      ...
      ServiceCategory(
        ...
        services: [
          ...
          Service(
            id: 'events',
            name: 'Events & Tickets',
            description: 'Concerts, sports, shows',
      ...
      ServiceCategory(
        ...
        services: [
          ...
          Service(
            ...
            icon: Icons.people,
            color: Colors.purple,
            route: '/singles-events',
          ),
          Service(
            id: 'matchmaking',
            name: 'Matchmaking',
            description: 'Professional matching',
    ...
    switch (service.id) {
      ...
      default:
        ScaffoldMessenger.of(
          context,
        ).showSnackBar(SnackBar(content: Text('${service.name} coming soon!')));
    }
  }
}
